...
int vmin = 60;
int vmax = 80;
int fadelante = 150;  // Frenos hacia delante
int fatras = 170;     // Frenos hacia atras
int vbase;

// PID
const float KP = 0.148;
const float KD = 1.002;
const float KI = 0.00187;
const float KV = 1;
...
int lectura(void) {
  ...
  // En caso de que se salga de ciertos limites, forzar al carro a girar
