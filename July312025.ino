...
int lectura(void){
  ...
  sumap = (700digital[0] + 600digital[1] + 500digital[2] + 400digital[3] + 300digital[4] + 200digital[5] + 100digital[6] + 0digital[7]);  
...
void PID(){
  ...
  vbase = vmin+(vmax-vmin)exp(-KVabs(KP*proporcional));
